...
namespace FilmFind.Services
{
    public class ImportService
    {
        public async Task<List<Movie>> GetMoviesOnline(string searchString)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    var filteredResults = FilteredResults(searchResults.Search);
                    foreach (var movieShort in filteredResults)
                    {
        ...
        private IEnumerable<ResultMovie> FilteredResults(IEnumerable<ResultMovie> searchResults)
        {
        ...
        {
            public List<ResultMovie> Search { get; set; }
