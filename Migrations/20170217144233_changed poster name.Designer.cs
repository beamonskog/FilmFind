...
namespace FilmFind.Migrations
{
    ...
    [Migration("20170217144233_changed poster name")]
    partial class changedpostername
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("FilmFind.Entities.GenreData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("FilmFind.Entities.Models.Movie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("FilmFind.Entities.GenreData", b =>
                {
                    b.HasOne("FilmFind.Entities.Models.Movie")
                        .WithMany("Genres")
